$(document).ready(function () {
    ...
    setInterval(function () {
        notifications();
    }, 60000); // every minute notifications are checked

});

function notifications() {
    $.ajax({
        url:'http://localhost/Khairi_pfe/web/app_dev.php/notifications/get',
        type: 'GET',
    ...
    $.ajax({
        url:'http://localhost/Khairi_pfe/web/app_dev.php/private-message/notification/get',
        type: 'GET',
        success: function (response) {
