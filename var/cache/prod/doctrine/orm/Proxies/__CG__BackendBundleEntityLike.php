 ...
 */
class Like extends \BackendBundle\Entity\Like implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Like' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Like' . "\0" . 'user', '' . "\0" . 'BackendBundle\\Entity\\Like' . "\0" . 'publication'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Like $proxy) {
