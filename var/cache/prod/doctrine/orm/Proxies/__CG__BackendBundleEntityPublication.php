 ...
 */
class Publication extends \BackendBundle\Entity\Publication implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Publication' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Publication' . "\0" . 'texto', '' . "\0" . 'BackendBundle\\Entity\\Publication' . "\0" . 'document', '' . "\0" . 'BackendBundle\\Entity\\Publication' . "\0" . 'image', '' . "\0" . 'BackendBundle\\Entity\\Publication' . "\0" . 'status', '' . "\0" . 'BackendBundle\\Entity\\Publication' . "\0" . 'createdAt', '' . "\0" . 'BackendBundle\\Entity\\Publication' . "\0" . 'user'];
        }
