 ...
 */
class PrivateMessage extends \BackendBundle\Entity\PrivateMessage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\PrivateMessage' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\PrivateMessage' . "\0" . 'message', '' . "\0" . 'BackendBundle\\Entity\\PrivateMessage' . "\0" . 'file', '' . "\0" . 'BackendBundle\\Entity\\PrivateMessage' . "\0" . 'image', '' . "\0" . 'BackendBundle\\Entity\\PrivateMessage' . "\0" . 'readed', '' . "\0" . 'BackendBundle\\Entity\\PrivateMessage' . "\0" . 'createdAt', '' . "\0" . 'BackendBundle\\Entity\\PrivateMessage' . "\0" . 'emitter', '' . "\0" . 'BackendBundle\\Entity\\PrivateMessage' . "\0" . 'receiver'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PrivateMessage $proxy) {
    ...
    public function setEmitter(\BackendBundle\Entity\User $emitter = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEmitter', [$emitter]);

        return parent::setEmitter($emitter);
    }
    ...
    public function getEmitter()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEmitter', []);
