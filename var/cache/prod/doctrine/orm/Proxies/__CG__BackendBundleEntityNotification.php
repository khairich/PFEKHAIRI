 ...
 */
class Notification extends \BackendBundle\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Notification' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Notification' . "\0" . 'type', '' . "\0" . 'BackendBundle\\Entity\\Notification' . "\0" . 'typeId', '' . "\0" . 'BackendBundle\\Entity\\Notification' . "\0" . 'readed', '' . "\0" . 'BackendBundle\\Entity\\Notification' . "\0" . 'createdAt', '' . "\0" . 'BackendBundle\\Entity\\Notification' . "\0" . 'extra', '' . "\0" . 'BackendBundle\\Entity\\Notification' . "\0" . 'user'];
        }
