...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.notification_service' => 'getApp_NotificationServiceService',
            ...
            'security.user.provider.concrete.user_db_provider' => 'getSecurity_User_Provider_Concrete_UserDbProviderService',
            ...
            'tag.form.type.tags' => 'getTag_Form_Type_TagsService',
    ...
    /**
     * Gets the 'app.notification_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\NotificationService A AppBundle\Services\NotificationService instance
     */
    protected function getApp_NotificationServiceService()
    {
        return $this->services['app.notification_service'] = new \AppBundle\Services\NotificationService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('aybxctzPJ3', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ikMHXPpKJW', 0, 'L8XkvvJgJ3+VmuzT1iogXq', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PBDvrkq234', 0, 'L8XkvvJgJ3+VmuzT1iogXq', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wxECzb9nZG', 0, 'L8XkvvJgJ3+VmuzT1iogXq', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'khairi_pfe', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\BackendBundle\\Resources\\config\\doctrine') => 'BackendBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Khairi\\SNEspritBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Resume\\SNBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Groupes\\SNBundle\\Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'BackendBundle\\Entity');
        $d->addDriver($c, 'Khairi\\SNEspritBundle\\Entity');
        $d->addDriver($c, 'Resume\\SNBundle\\Entity');
        $d->addDriver($c, 'Groupes\\SNBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('BackendBundle' => 'BackendBundle\\Entity', 'KhairiSNEspritBundle' => 'Khairi\\SNEspritBundle\\Entity', 'ResumeSNBundle' => 'Resume\\SNBundle\\Entity', 'GroupesSNBundle' => 'Groupes\\SNBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_b1a7ffdc976a6c91ed310e4a2ecea0d75e478df02fb3d839bc19f94c4a3a0a81');
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'AppBundle:Layouts:custom_pagination.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 5));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('BackendBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 4))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(login|register|nick-test)');
        ...
        $j->add($i, array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN'), NULL);
    ...
    /**
     * Gets the 'tag.form.type.tags' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Khairi\SNEspritBundle\Form\Type\TagsType A Khairi\SNEspritBundle\Form\Type\TagsType instance
     */
    protected function getTag_Form_Type_TagsService()
    {
        return $this->services['tag.form.type.tags'] = new \Khairi\SNEspritBundle\Form\Type\TagsType($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \AppBundle\Twig\FollowExtension($a));
        $instance->addExtension(new \AppBundle\Twig\LongTimeExtension());
        $instance->addExtension(new \AppBundle\Twig\LikeExtension($a));
        $instance->addExtension(new \AppBundle\Twig\UserStatsExtension($a));
        $instance->addExtension(new \AppBundle\Twig\GetUserExtension($a));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Khairi\\SNEspritBundle/Resources/views'), 'KhairiSNEsprit');
        $instance->addPath(($this->targetDirs[3].'\\src\\Resume\\SNBundle/Resources/views'), 'ResumeSN');
        $instance->addPath(($this->targetDirs[3].'\\src\\Groupes\\SNBundle/Resources/views'), 'GroupesSN');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.user_db_provider'), $this->get('security.user_checker.main'), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5afc3cff5b4db3.59824077')), true);
    ...
    /**
     * Gets the 'security.user.provider.concrete.user_db_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_UserDbProviderService()
    {
        return $this->services['security.user.provider.concrete.user_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'BackendBundle:User', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'KhairiSNEspritBundle' => 'Khairi\\SNEspritBundle\\KhairiSNEspritBundle',
                'ResumeSNBundle' => 'Resume\\SNBundle\\ResumeSNBundle',
                'GroupesSNBundle' => 'Groupes\\SNBundle\\GroupesSNBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'KhairiSNEspritBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Khairi\\SNEspritBundle'),
                    'namespace' => 'Khairi\\SNEspritBundle',
                ),
                'ResumeSNBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Resume\\SNBundle'),
                    'namespace' => 'Resume\\SNBundle',
                ),
                'GroupesSNBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Groupes\\SNBundle'),
                    'namespace' => 'Groupes\\SNBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
            ...
            'knp_paginator.template.pagination' => 'AppBundle:Layouts:custom_pagination.html.twig',
